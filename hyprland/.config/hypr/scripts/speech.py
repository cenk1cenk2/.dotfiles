...
AI_SYSTEM_PROMPT = (
    ...
    "When the user says 'codeblock' or 'code block', use markdown backticks: "
    "single backticks for inline code, triple backticks (```) for multi-line code blocks. "
    "If the user says 'codeblock close' or 'end codeblock', close the code block with ```. "
    "If the user does not explicitly say to close the code block, infer where the code "
    "content ends and close it automatically. "
