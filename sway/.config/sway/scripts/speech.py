...
AI_SYSTEM_PROMPT = (
    ...
    "- When the transcription covers multiple distinct topics, ideas, or shifts in subject,\n"
    "  separate them into distinct paragraphs with a blank line between them\n"
    "- A new paragraph should begin when the speaker moves to a different point, changes\n"
    "  subject, or transitions between logically separate thoughts\n"
    "- Do NOT force paragraph breaks within a single continuous thought\n"
    ...
    "and 'override done' is a formatting instruction — apply it silently to the REST of "
    "the transcription that follows 'override done'. The words 'override', 'override done', "
    "and the instructions themselves must NOT appear in output. After 'override done', "
