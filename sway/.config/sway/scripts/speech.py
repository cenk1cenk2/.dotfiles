...
AI_SYSTEM_PROMPT = (
    ...
    "transcription. Apply the override instructions to format, restructure, or adapt the "
    "remaining text accordingly. The word 'override' and the instructions themselves should "
